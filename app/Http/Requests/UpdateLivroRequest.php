...
class UpdateLivroRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            'titulo' => [
                'required',
                Rule::unique('livros')->ignore($this->livro),
                'max:255'
            ],
            'numero_registro' => [
                'required',
    ...
    public function messages(): array
    {
        return [
            ...
            'titulo.unique' => 'Já existe outro livro cadastrado com esse título',
            ...
            'numero_registro.unique' => 'Já existe outro livro cadastrado com esse número de registro',
